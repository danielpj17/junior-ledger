...
export default function JuniorAssistant() {
  const [messages, setMessages] = useState<Array<{ id: string; text: string; sender: 'user' | 'assistant' }>>([
    { id: '1', text: "Hi! I'm your Junior Assistant. How can I help you today?", sender: 'assistant' }
  ]);
  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    try {
      const response = await sendChatMessage(userMessage, tutorMode);
    ...
    <div className="h-[calc(100vh-8rem)] max-h-[800px] flex flex-col bg-white rounded-lg shadow-lg border border-gray-200">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-[#002E5D] text-white rounded-t-lg">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold">Junior Assistant</h3>
        </div>
